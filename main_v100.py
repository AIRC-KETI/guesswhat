        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(model):
                ...
                if args.with_tracking:
                    ...
                    total_class_loss = total_class_loss + loss.detach().float() if class_loss is not None else None
            ...
            accelerator.log(
                {
                    ...
                    "train_answer_loss": total_loss.item() / len(train_dataloader),
                    "train_class_loss": total_class_loss.item() / len(train_dataloader) if outputs.class_logits is not None else None,
                    "epoch": epoch,
